...
$subscriptionId = "d858cbed-06c5-4813-82d7-f90584938f61" #insert your subscription ID
$resourceGroupName = "CIaCS-Tamanna"  #provide resource group name
...
$templateFileURI = 'https://raw.githubusercontent.com/TamannaPradhan9/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/template.json'
$parametersFileURI = 'https://raw.githubusercontent.com/TamannaPradhan9/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/paramters.json'
